...
async function mediumButton() {
    colorButton('btn_medium', 'button-orange', 'arrowWhiteMedium', 'arrowOrangeMedium', 'medium');
}
...
function colorButton(btn_prio, button_color, arrowWhitePrio, arrowColorPrio, prio = 'medium') {
...
function reloadPage(validatedPage) {
    clearPrioButtons();
    validatedPage == 'board' ? getAddTask() : getBoard();
}
